...
thumb and one you cannot. Four of the seventeen targets are touch screens.
...
So `rmp::app::quit()` is inert on iOS by design. The same source ships to all seventeen targets
